...
include::{projDir}/ReadMe.adoc[]
include::{projDir}/groovy-examples/ReadMe.adoc[]
include::{projDir}/java-examples/ReadMe.adoc[]
...
=== Git
* https://www.javacodegeeks.com/2016/07/git-tutorial.html[Git Tutorial – The Ultimate Guide]
...
* https://examples.javacodegeeks.com/software-development/git/git-tree-viewer-example/[Git Tree View]
